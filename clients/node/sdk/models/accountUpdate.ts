import {createAccountUpdateFromDiscriminatorValue} from './createAccountUpdateFromDiscriminatorValue';
...
import {createSourceUpdateFromDiscriminatorValue} from './createSourceUpdateFromDiscriminatorValue';
import {Emoji, Field, SourceUpdate} from './index';
import {AdditionalDataHolder, Parsable, ParseNode, SerializationWriter} from '@microsoft/kiota-abstractions';

export class AccountUpdate implements AdditionalDataHolder, Parsable {
    /** The acct property */
    ...
    /** The moved property */
    private _moved?: AccountUpdate | undefined;
    /** The mute_expires_at property */
    private _mute_expires_at?: string | undefined;
    /** The note property */
    private _note?: string | undefined;
    /** The souce property */
    private _souce?: SourceUpdate | undefined;
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "moved": n => { this.moved = n.getObjectValue<AccountUpdate>(createAccountUpdateFromDiscriminatorValue); },
            "mute_expires_at": n => { this.mute_expires_at = n.getStringValue(); },
            "note": n => { this.note = n.getStringValue(); },
            "souce": n => { this.souce = n.getObjectValue<SourceUpdate>(createSourceUpdateFromDiscriminatorValue); },
     ...
     */
    public set moved(value: AccountUpdate | undefined) {
        this._moved = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeObjectValue<AccountUpdate>("moved", this.moved);
        writer.writeStringValue("mute_expires_at", this.mute_expires_at);
        writer.writeStringValue("note", this.note);
        writer.writeObjectValue<SourceUpdate>("souce", this.souce);
     ...
     */
    public set souce(value: SourceUpdate | undefined) {
        this._souce = value;
    };
    /**
