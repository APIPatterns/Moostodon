...
export class Status implements AdditionalDataHolder, Parsable {
    ...
    /** The card property */
    private _card?: string | undefined;
    ...
    private _media_attachments?: string[] | undefined;
    /** The mentions property */
    private _mentions?: string[] | undefined;
    /** The muted property */
    private _muted?: boolean | undefined;
    /** The pinned property */
    private _pinned?: boolean | undefined;
    /** The poll property */
    private _poll?: string | undefined;
    /** The reblog property */
     ...
     */
    public set card(value: string | undefined) {
        this._card = value;
    };
    /**
    ...
    public getFieldDeserializers() : Record<string, (node: ParseNode) => void> {
        return {
            ...
            "media_attachments": n => { this.media_attachments = n.getCollectionOfPrimitiveValues<string>(); },
            "mentions": n => { this.mentions = n.getCollectionOfPrimitiveValues<string>(); },
     ...
     */
    public set media_attachments(value: string[] | undefined) {
     ...
     */
    public set mentions(value: string[] | undefined) {
     ...
     */
    public set poll(value: string | undefined) {
        this._poll = value;
    };
    /**
    ...
    public serialize(writer: SerializationWriter) : void {
        ...
        writer.writeCollectionOfPrimitiveValues<string>("media_attachments", this.media_attachments);
        writer.writeCollectionOfPrimitiveValues<string>("mentions", this.mentions);
