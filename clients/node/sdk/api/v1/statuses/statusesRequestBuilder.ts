...
export class StatusesRequestBuilder {
     ...
     */
    public toPostRequestInformation(body: ArrayBuffer | undefined, requestConfiguration?: StatusesRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
