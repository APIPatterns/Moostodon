...
export class AppsRequestBuilder {
     ...
     */
    public toPostRequestInformation(body: ArrayBuffer | undefined, requestConfiguration?: AppsRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
