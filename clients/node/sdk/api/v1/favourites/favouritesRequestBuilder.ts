...
import {FavouritesRequestBuilderGetRequestConfiguration} from './favouritesRequestBuilderGetRequestConfiguration';
import {getPathParameters, HttpMethod, Parsable, ParsableFactory, RequestAdapter, RequestInformation, RequestOption, ResponseHandler} from '@microsoft/kiota-abstractions';

/** Builds and executes requests for operations under /api/v1/favourites */
export class FavouritesRequestBuilder {
    ...
    public createGetRequestInformation(requestConfiguration?: FavouritesRequestBuilderGetRequestConfiguration | undefined) : RequestInformation {
    ...
    public get(requestConfiguration?: FavouritesRequestBuilderGetRequestConfiguration | undefined, responseHandler?: ResponseHandler | undefined) : Promise<Status[] | undefined> {
