...
exports.ListsRequestBuilder = void 0;
const createAccountListFromDiscriminatorValue_1 = require("../../../../../models/createAccountListFromDiscriminatorValue");
...
class ListsRequestBuilder {
    ...
    get(requestConfiguration, responseHandler) {
        ...
        return (_b = (_a = this.requestAdapter) === null || _a === void 0 ? void 0 : _a.sendCollectionAsync(requestInfo, createAccountListFromDiscriminatorValue_1.createAccountListFromDiscriminatorValue, responseHandler, errorMapping)) !== null && _b !== void 0 ? _b : Promise.reject(new Error('request adapter is null'));
    }
    ;
}
exports.ListsRequestBuilder = ListsRequestBuilder;
