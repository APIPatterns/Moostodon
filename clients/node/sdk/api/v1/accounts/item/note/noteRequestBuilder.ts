...
export class NoteRequestBuilder {
     ...
     */
    public toPostRequestInformation(body: ArrayBuffer | undefined, requestConfiguration?: NoteRequestBuilderPostRequestConfiguration | undefined) : RequestInformation {
        if(!body) throw new Error("body cannot be undefined");
