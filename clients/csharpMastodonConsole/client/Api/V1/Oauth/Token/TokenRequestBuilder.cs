...
namespace MastodonClientLib.Api.V1.Oauth.Token {
    ...
    public class TokenRequestBuilder {
        ...
        public async Task<TokenResponse> PostAsync(Stream body, Action<TokenRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = CreatePostRequestInformation(body, requestConfiguration);
            return await RequestAdapter.SendAsync<TokenResponse>(requestInfo, TokenResponse.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
