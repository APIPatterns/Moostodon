...
namespace MastodonClientLib.Api.V1.Accounts.Item {
    /// <summary>Builds and executes requests for operations under \api\v1\accounts\{id}</summary>
    public class AccountsItemRequestBuilder {
        ...
        public RequestInformation CreateGetRequestInformation(Action<AccountsItemRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        public RequestInformation CreatePatchRequestInformation(Account body, Action<AccountsItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
        ...
        public async Task<Account> GetAsync(Action<AccountsItemRequestBuilderGetRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<Account>(requestInfo, Account.CreateFromDiscriminatorValue, responseHandler, default, cancellationToken);
        }
        public async Task<Account> PatchAsync(Account body, Action<AccountsItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
