...
namespace MastodonClientLib.Api.V1.Accounts {
    ...
    public class AccountsRequestBuilder {
        ...
        public async Task<Account> PostAsync(Stream body, Action<AccountsRequestBuilderPostRequestConfiguration> requestConfiguration = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = body ?? throw new ArgumentNullException(nameof(body));
