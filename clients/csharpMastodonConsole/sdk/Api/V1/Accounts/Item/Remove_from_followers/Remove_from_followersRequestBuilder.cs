...
namespace MastodonClientLib.Api.V1.Accounts.Item.Remove_from_followers {
    /// <summary>Builds and executes requests for operations under \api\v1\accounts\{id}\remove_from_followers</summary>
    public class Remove_from_followersRequestBuilder {
        ...
        public Remove_from_followersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/api/v1/accounts/{id}/remove_from_followers";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Remove_from_followersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public RequestInformation CreatePostRequestInformation(Action<Remove_from_followersRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
