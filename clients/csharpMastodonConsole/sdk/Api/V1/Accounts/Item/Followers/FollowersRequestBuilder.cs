...
namespace MastodonClientLib.Api.V1.Accounts.Item.Followers {
    /// <summary>Builds and executes requests for operations under \api\v1\accounts\{id}\followers</summary>
    public class FollowersRequestBuilder {
        ...
        public RequestInformation CreateGetRequestInformation(Action<FollowersRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
