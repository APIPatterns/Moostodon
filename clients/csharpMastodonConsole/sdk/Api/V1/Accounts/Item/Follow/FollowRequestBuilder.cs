...
namespace MastodonClientLib.Api.V1.Accounts.Item.Follow {
    /// <summary>Builds and executes requests for operations under \api\v1\accounts\{id}\follow</summary>
    public class FollowRequestBuilder {
        ...
        public FollowRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/api/v1/accounts/{id}/follow";
        ...
        public RequestInformation CreatePostRequestInformation(FollowBody body, Action<FollowRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
