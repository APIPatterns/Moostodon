...
namespace MastodonClientLib.Api.V1.Accounts.Item.Featured_tags {
    /// <summary>Builds and executes requests for operations under \api\v1\accounts\{id}\featured_tags</summary>
    public class Featured_tagsRequestBuilder {
        ...
        public Featured_tagsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/api/v1/accounts/{id}/featured_tags";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Featured_tagsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public RequestInformation CreateGetRequestInformation(Action<Featured_tagsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
