...
namespace MastodonClientLib.Api.V1.Accounts.Item.Unmute {
    /// <summary>Builds and executes requests for operations under \api\v1\accounts\{id}\unmute</summary>
    public class UnmuteRequestBuilder {
        ...
        public UnmuteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/api/v1/accounts/{id}/unmute";
        ...
        public RequestInformation CreatePostRequestInformation(Action<UnmuteRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
