...
namespace MastodonClientLib.Api.V1.Accounts.Search {
    /// <summary>Builds and executes requests for operations under \api\v1\accounts\search</summary>
    public class SearchRequestBuilder {
        ...
        public SearchRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/api/v1/accounts/search{?q*,limit*,following*,resolve*}";
