...
namespace MastodonClientLib.Api.V1.Endorsements {
    /// <summary>Builds and executes requests for operations under \api\v1\endorsements</summary>
    public class EndorsementsRequestBuilder {
        ...
        public EndorsementsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/api/v1/endorsements{?max_Id*,sinceId*,min_Id*,limit*}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public EndorsementsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public RequestInformation CreateGetRequestInformation(Action<EndorsementsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
