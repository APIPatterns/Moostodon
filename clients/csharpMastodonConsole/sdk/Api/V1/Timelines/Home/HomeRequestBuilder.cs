...
namespace MastodonClientLib.Api.V1.Timelines.Home {
    /// <summary>Builds and executes requests for operations under \api\v1\timelines\home</summary>
    public class HomeRequestBuilder {
        ...
        public HomeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/api/v1/timelines/home{?max_Id*,sinceId*,min_Id*,limit*}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public HomeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public RequestInformation CreateGetRequestInformation(Action<HomeRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
