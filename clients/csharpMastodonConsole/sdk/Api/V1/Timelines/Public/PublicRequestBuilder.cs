...
namespace MastodonClientLib.Api.V1.Timelines.Public {
    /// <summary>Builds and executes requests for operations under \api\v1\timelines\public</summary>
    public class PublicRequestBuilder {
        ...
        public PublicRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/api/v1/timelines/public{?local*,only_media*,max_Id*,sinceId*,min_Id*,limit*}";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PublicRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public RequestInformation CreateGetRequestInformation(Action<PublicRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
