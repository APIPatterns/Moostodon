...
namespace MastodonClientLib.Api.V1.Statuses.Item.Reblog {
    /// <summary>Builds and executes requests for operations under \api\v1\statuses\{id}\reblog</summary>
    public class ReblogRequestBuilder {
        ...
        public ReblogRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/api/v1/statuses/{id}/reblog";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ReblogRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public RequestInformation CreatePostRequestInformation(Action<ReblogRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
