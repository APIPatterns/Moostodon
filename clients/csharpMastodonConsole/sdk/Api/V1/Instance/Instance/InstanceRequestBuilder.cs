...
namespace MastodonClientLib.Api.V1.Instance.Instance {
    /// <summary>Builds and executes requests for operations under \api\v1\instance\instance</summary>
    public class InstanceRequestBuilder {
        ...
        public InstanceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/api/v1/instance/instance";
