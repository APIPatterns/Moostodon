...
source_update = lazy_import('mastodon_client_lib.models.source_update')

class AccountUpdate(AdditionalDataHolder, Parsable):
    @property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> AccountUpdate:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "moved": lambda n : setattr(self, 'moved', n.get_object_value(AccountUpdate)),
            "mute_expires_at": lambda n : setattr(self, 'mute_expires_at', n.get_str_value()),
            "note": lambda n : setattr(self, 'note', n.get_str_value()),
            "souce": lambda n : setattr(self, 'souce', n.get_object_value(source_update.SourceUpdate)),
    ...
    @property
    def moved(self,) -> Optional[AccountUpdate]:
        """
        Gets the moved property value. The moved property
        Returns: Optional[AccountUpdate]
        """
        return self._moved
    
    @moved.setter
    def moved(self,value: Optional[AccountUpdate] = None) -> None:
        """
    ...
    @property
    def souce(self,) -> Optional[source_update.SourceUpdate]:
        """
        Gets the souce property value. The souce property
        Returns: Optional[source_update.SourceUpdate]
        """
        return self._souce
    
    @souce.setter
    def souce(self,value: Optional[source_update.SourceUpdate] = None) -> None:
        """
