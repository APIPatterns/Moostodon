...
class MuteRequestBuilder():
    ...
    async def post(self,body: bytes, request_configuration: Optional[MuteRequestBuilderPostRequestConfiguration] = None) -> Optional[relationship.Relationship]:
        if body is None:
    ...
    def to_post_request_information(self,body: bytes, request_configuration: Optional[MuteRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        if body is None:
            raise Exception("body cannot be undefined")
