...
class Remove_from_followersRequestBuilder():
    ...
    async def post(self,request_configuration: Optional[Remove_from_followersRequestBuilderPostRequestConfiguration] = None) -> Optional[relationship.Relationship]:
    ...
    def to_post_request_information(self,request_configuration: Optional[Remove_from_followersRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
