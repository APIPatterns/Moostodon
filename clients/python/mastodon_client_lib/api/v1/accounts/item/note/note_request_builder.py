...
class NoteRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/api/v1/accounts/{id}/note"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def post(self,body: bytes, request_configuration: Optional[NoteRequestBuilderPostRequestConfiguration] = None) -> Optional[relationship.Relationship]:
        if body is None:
    ...
    def to_post_request_information(self,body: bytes, request_configuration: Optional[NoteRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        if body is None:
            raise Exception("body cannot be undefined")
    ...
    @dataclass
    class NoteRequestBuilderPostRequestConfiguration():
        """
