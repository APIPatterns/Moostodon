...
class RelationshipsRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[RelationshipsRequestBuilderGetRequestConfiguration] = None) -> Optional[List[relationship.Relationship]]:
        ...
        return await self.request_adapter.send_collection_async(request_info, relationship.Relationship, error_mapping)
