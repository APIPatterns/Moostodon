...
status_edit = lazy_import('mastodon_client_lib.models.status_edit')
...
class HistoryRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[HistoryRequestBuilderGetRequestConfiguration] = None) -> Optional[List[status_edit.StatusEdit]]:
        request_info = self.to_get_request_information(
            request_configuration
        )
        if not self.request_adapter:
            raise Exception("Http core is null") 
        return await self.request_adapter.send_collection_async(request_info, status_edit.StatusEdit, None)
