...
class PublicRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[PublicRequestBuilderGetRequestConfiguration] = None) -> Optional[List[status.Status]]:
    ...
    def to_get_request_information(self,request_configuration: Optional[PublicRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
