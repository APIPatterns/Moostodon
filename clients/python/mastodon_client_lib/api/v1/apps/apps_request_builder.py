...
verify_credentials_request_builder = lazy_import('mastodon_client_lib.api.v1.apps.verify_credentials.verify_credentials_request_builder')
...
class AppsRequestBuilder():
    ...
    async def post(self,body: bytes, request_configuration: Optional[AppsRequestBuilderPostRequestConfiguration] = None) -> Optional[application.Application]:
        if body is None:
    ...
    def to_post_request_information(self,body: bytes, request_configuration: Optional[AppsRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
        if body is None:
            raise Exception("body cannot be undefined")
