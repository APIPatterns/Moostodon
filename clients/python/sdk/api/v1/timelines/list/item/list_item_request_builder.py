...
class ListItemRequestBuilder():
    """
    Builds and executes requests for operations under /api/v1/timelines/list/{id}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/api/v1/timelines/list/{id}{?max_Id*,sinceId*,min_Id*,limit*}"

        url_tpl_params = get_path_parameters(path_parameters)
        self.path_parameters = url_tpl_params
        self.request_adapter = request_adapter
    
    async def get(self,request_configuration: Optional[ListItemRequestBuilderGetRequestConfiguration] = None) -> Optional[List[status.Status]]:
