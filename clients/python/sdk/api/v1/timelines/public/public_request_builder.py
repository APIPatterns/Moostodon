...
class PublicRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[PublicRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
    ...
    async def get(self,request_configuration: Optional[PublicRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[List[status.Status]]:
