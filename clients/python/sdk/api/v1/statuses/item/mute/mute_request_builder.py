...
class MuteRequestBuilder():
    ...
    async def post(self,request_configuration: Optional[MuteRequestBuilderPostRequestConfiguration] = None) -> Optional[status.Status]:
    ...
    def to_post_request_information(self,request_configuration: Optional[MuteRequestBuilderPostRequestConfiguration] = None) -> RequestInformation:
