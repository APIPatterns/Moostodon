...
class Verify_credentialsRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/api/v1/accounts/verify_credentials"
    ...
    async def get(self,request_configuration: Optional[Verify_credentialsRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[account.Account]:
