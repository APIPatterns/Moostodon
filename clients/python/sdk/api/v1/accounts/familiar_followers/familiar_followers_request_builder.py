...
class Familiar_followersRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/api/v1/accounts/familiar_followers{?id*}"
    ...
    class Familiar_followersRequestBuilderGetRequestConfiguration():
        ...
        query_parameters: Optional[Familiar_followersRequestBuilder.Familiar_followersRequestBuilderGetQueryParameters] = None
