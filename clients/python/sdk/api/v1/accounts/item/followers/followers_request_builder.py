...
class FollowersRequestBuilder():
    ...
    def create_get_request_information(self,request_configuration: Optional[FollowersRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
    ...
    async def get(self,request_configuration: Optional[FollowersRequestBuilderGetRequestConfiguration] = None, response_handler: Optional[ResponseHandler] = None) -> Optional[List[account.Account]]:
