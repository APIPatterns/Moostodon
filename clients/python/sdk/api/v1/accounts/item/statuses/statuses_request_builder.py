...
class StatusesRequestBuilder():
    ...
    async def get(self,request_configuration: Optional[StatusesRequestBuilderGetRequestConfiguration] = None) -> Optional[List[status.Status]]:
    ...
    def to_get_request_information(self,request_configuration: Optional[StatusesRequestBuilderGetRequestConfiguration] = None) -> RequestInformation:
