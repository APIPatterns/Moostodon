...
class Domain_blocksRequestBuilder():
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        self.url_template: str = "{+baseurl}/api/v1/domain_blocks{?max_Id*,sinceId*,min_Id*,limit*,domain*}"
    ...
    @dataclass
    class Domain_blocksRequestBuilderDeleteRequestConfiguration():
        """
        ...
        query_parameters: Optional[Domain_blocksRequestBuilder.Domain_blocksRequestBuilderDeleteQueryParameters] = None

    
    @dataclass
    class Domain_blocksRequestBuilderGetQueryParameters():
    ...
    @dataclass
    class Domain_blocksRequestBuilderGetRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
        ...
        # Request query parameters
        query_parameters: Optional[Domain_blocksRequestBuilder.Domain_blocksRequestBuilderGetQueryParameters] = None

    
    @dataclass
    class Domain_blocksRequestBuilderPostRequestConfiguration():
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        # Request headers
