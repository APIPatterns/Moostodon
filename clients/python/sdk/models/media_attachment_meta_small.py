...
class MediaAttachmentMetaSmall(AdditionalDataHolder, Parsable):
    @property
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: Optional[ParseNode] = None) -> MediaAttachmentMetaSmall:
        """
        Creates a new instance of the appropriate class based on discriminator value
        Args:
            parseNode: The parse node to use to read the discriminator value and create the object
        Returns: MediaAttachmentMetaSmall
        """
        if parse_node is None:
            raise Exception("parse_node cannot be undefined")
        return MediaAttachmentMetaSmall()
