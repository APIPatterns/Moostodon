...
class Status(AdditionalDataHolder, Parsable):
    ...
    @card.setter
    def card(self,value: Optional[str] = None) -> None:
        """
    ...
    def __init__(self,) -> None:
        ...
        self._media_attachments: Optional[List[str]] = None
        # The mentions property
        self._mentions: Optional[List[str]] = None
        # The muted property
        self._muted: Optional[bool] = None
        # The pinned property
        self._pinned: Optional[bool] = None
        # The poll property
        self._poll: Optional[str] = None
        # The reblog property
    ...
    @property
    def emojis(self,) -> Optional[List[str]]:
        """
    ...
    @emojis.setter
    def emojis(self,value: Optional[List[str]] = None) -> None:
        """
    ...
    def get_field_deserializers(self,) -> Dict[str, Callable[[ParseNode], None]]:
        ...
        fields = {
            ...
            "card": lambda n : setattr(self, 'card', n.get_str_value()),
            ...
            "media_attachments": lambda n : setattr(self, 'media_attachments', n.get_collection_of_primitive_values(str)),
            "mentions": lambda n : setattr(self, 'mentions', n.get_collection_of_primitive_values(str)),
            "muted": lambda n : setattr(self, 'muted', n.get_bool_value()),
            "pinned": lambda n : setattr(self, 'pinned', n.get_bool_value()),
            "poll": lambda n : setattr(self, 'poll', n.get_str_value()),
    ...
    @property
    def media_attachments(self,) -> Optional[List[str]]:
        """
    ...
    def media_attachments(self,value: Optional[List[str]] = None) -> None:
        """
    ...
    @mentions.setter
    def mentions(self,value: Optional[List[str]] = None) -> None:
        """
    ...
    @poll.setter
    def poll(self,value: Optional[str] = None) -> None:
        """
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("card", self.card)
        ...
        writer.write_collection_of_primitive_values("media_attachments", self.media_attachments)
        ...
        writer.write_str_value("poll", self.poll)
