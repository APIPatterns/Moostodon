...
namespace MastodonClientLib.Api.V1.Apps.Verify_credentials {
    ...
    public class Verify_credentialsRequestBuilder : BaseRequestBuilder {
        ...
        public Verify_credentialsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/apps/verify_credentials", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new Verify_credentialsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Verify_credentialsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/apps/verify_credentials", rawUrl) {
        }
