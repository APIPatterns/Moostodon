...
namespace MastodonClientLib.Api.V1.Timelines.Tag.Item {
    /// <summary>
    /// Builds and executes requests for operations under \api\v1\timelines\tag\{tag}
    /// </summary>
    public class WithTagItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithTagItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/timelines/tag/{tag}{?local*,only_media*,max_Id*,sinceId*,min_Id*,limit*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithTagItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithTagItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/timelines/tag/{tag}{?local*,only_media*,max_Id*,sinceId*,min_Id*,limit*}", rawUrl) {
        }
