...
namespace MastodonClientLib.Api.V1.Accounts.Verify_credentials {
    /// <summary>Builds and executes requests for operations under \api\v1\accounts\verify_credentials</summary>
    public class Verify_credentialsRequestBuilder {
        ...
        public Verify_credentialsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/api/v1/accounts/verify_credentials";
