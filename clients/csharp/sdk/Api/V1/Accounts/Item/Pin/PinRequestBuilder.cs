...
namespace MastodonClientLib.Api.V1.Accounts.Item.Pin {
    ...
    public class PinRequestBuilder : BaseRequestBuilder {
        ...
        public PinRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/accounts/{id}/pin", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PinRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PinRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/accounts/{id}/pin", rawUrl) {
        }
