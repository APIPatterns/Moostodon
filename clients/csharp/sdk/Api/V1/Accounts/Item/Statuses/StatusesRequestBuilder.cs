...
namespace MastodonClientLib.Api.V1.Accounts.Item.Statuses {
    ...
    public class StatusesRequestBuilder : BaseRequestBuilder {
        ...
        public StatusesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/accounts/{id}/statuses{?max_Id*,sinceId*,min_Id*,limit*,exclude_reblogs*,tagged*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new StatusesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StatusesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/accounts/{id}/statuses{?max_Id*,sinceId*,min_Id*,limit*,exclude_reblogs*,tagged*}", rawUrl) {
        }
