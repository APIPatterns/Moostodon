...
using System;
namespace MastodonClientLib.Api.V1.Accounts.Item.Mute {
    /// <summary>
    ...
    public class MuteRequestBuilder : BaseRequestBuilder {
        ...
        public MuteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/accounts/{id}/mute", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MuteRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MuteRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/accounts/{id}/mute", rawUrl) {
        }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(MuteForm body, Action<MuteRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(MuteForm body, Action<MuteRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
