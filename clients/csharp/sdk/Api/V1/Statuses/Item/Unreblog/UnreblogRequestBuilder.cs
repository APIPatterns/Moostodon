...
namespace MastodonClientLib.Api.V1.Statuses.Item.Unreblog {
    ...
    /// </summary>
    public class UnreblogRequestBuilder {
        ...
        public UnreblogRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/api/v1/statuses/{id}/unreblog";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UnreblogRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
