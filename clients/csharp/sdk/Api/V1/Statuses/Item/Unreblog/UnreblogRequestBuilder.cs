...
namespace MastodonClientLib.Api.V1.Statuses.Item.Unreblog {
    /// <summary>Builds and executes requests for operations under \api\v1\statuses\{id}\unreblog</summary>
    public class UnreblogRequestBuilder {
        ...
        public RequestInformation CreatePostRequestInformation(Action<UnreblogRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
