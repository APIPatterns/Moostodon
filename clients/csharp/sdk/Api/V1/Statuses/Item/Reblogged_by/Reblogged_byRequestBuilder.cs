...
namespace MastodonClientLib.Api.V1.Statuses.Item.Reblogged_by {
    ...
    public class Reblogged_byRequestBuilder {
        ...
        public Reblogged_byRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Reblogged_byRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
