...
namespace MastodonClientLib.Api.V1.Statuses.Item.Reblogged_by {
    ...
    /// </summary>
    public class Reblogged_byRequestBuilder : BaseRequestBuilder {
        /// <summary>
        /// Instantiates a new Reblogged_byRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Reblogged_byRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/statuses/{id}/reblogged_by", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new Reblogged_byRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public Reblogged_byRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/statuses/{id}/reblogged_by", rawUrl) {
        }
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<Reblogged_byRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new Reblogged_byRequestBuilderGetRequestConfiguration();
        ...
        public class Reblogged_byRequestBuilderGetRequestConfiguration {
            ...
            /// <summary>
            /// Instantiates a new reblogged_byRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
