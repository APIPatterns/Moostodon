...
namespace MastodonClientLib.Api.V1.Statuses.Item.Unfavourite {
    /// <summary>Builds and executes requests for operations under \api\v1\statuses\{id}\unfavourite</summary>
    public class UnfavouriteRequestBuilder {
        ...
        public UnfavouriteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/api/v1/statuses/{id}/unfavourite";
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UnfavouriteRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) {
        ...
        public RequestInformation CreatePostRequestInformation(Action<UnfavouriteRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
