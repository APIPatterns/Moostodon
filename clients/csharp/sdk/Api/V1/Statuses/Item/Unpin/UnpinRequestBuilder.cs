...
namespace MastodonClientLib.Api.V1.Statuses.Item.Unpin {
    /// <summary>
    /// Builds and executes requests for operations under \api\v1\statuses\{id}\unpin
    /// </summary>
    public class UnpinRequestBuilder : BaseRequestBuilder {
        ...
        public UnpinRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/statuses/{id}/unpin", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UnpinRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UnpinRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v1/statuses/{id}/unpin", rawUrl) {
        }
