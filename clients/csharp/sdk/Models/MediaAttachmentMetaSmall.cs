...
namespace MastodonClientLib.Models {
    public class MediaAttachmentMetaSmall : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public MediaAttachmentMetaSmall() {
        ...
        public static MediaAttachmentMetaSmall CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new MediaAttachmentMetaSmall();
        }
        /// <summary>
