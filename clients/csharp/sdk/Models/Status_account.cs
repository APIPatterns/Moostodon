...
namespace MastodonClientLib.Models {
    public class Status_account : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new Status_account and sets the default values.
        /// </summary>
        ...
        public static Status_account CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Status_account();
        }
        /// <summary>
